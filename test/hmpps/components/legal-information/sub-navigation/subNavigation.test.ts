...
describe('Tests for sub navigation component', () => {
  it.each([
    ...
    [
      ...
      'https://custody-manager-dev.hmpps.service.justice.gov.uk/prisoner/ABC123/documents',
    ],
    [
      'pre',
      'https://custody-manager-preprod.hmpps.service.justice.gov.uk/prisoner/ABC123/overview',
      ...
      'https://custody-manager-preprod.hmpps.service.justice.gov.uk/prisoner/ABC123/documents',
    ],
    [
      'prod',
      'https://custody-manager.hmpps.service.justice.gov.uk/prisoner/ABC123/overview',
      ...
      'https://custody-manager.hmpps.service.justice.gov.uk/prisoner/ABC123/documents',
    ],
  ])(
    ...
    (
      ...
      expect(links['Calculations and release dates']).toStrictEqual(expectedCrd)
  ...
  it('should highlight the active tab', () => {
    ...
    expect(pages['Calculations and release dates']).toStrictEqual('page')
